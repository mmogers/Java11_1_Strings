...
public class TextSearch {
    public static void main(String[] args) {
        ...
        lastIndex = fullText.lastIndexOf(searchString, 19); //12
        System.out.println("And now the lastIndex = " + lastIndex);

        lastIndex = fullText.lastIndexOf(searchString, 15);//12
        System.out.println("And now the lastIndex = " + lastIndex);
        ...
        System.out.println(mississippi.regionMatches(0, "miss", 0, 4)); //true

        // Region Matches, ignore case, exact substring
        System.out.println(mississippi.regionMatches(true,0, "MISS", 0, 4)); //true
