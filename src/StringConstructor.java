...
public class StringConstructor {
    ...
    public static void main(String[] args) {
        ...
        // Create a String from the character array
        int offset = 1;
        //String charString2 = new String(alphabet, offset, alphabet_len ); //run time error because offset not 0 and it exceeds the alphabet_len, need to correct 3rd argyument
        String charString2 = new String(alphabet, offset, alphabet_len - offset);
        System.out.println("charString2 = " + charString2);

        // Only want f-j now.
        offset = 5;
        int length = 5; // 5 characters starting from 6th
